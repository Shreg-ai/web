  ...
  return (
    <div className="flex flex-1 items-center justify-center bg-gradient-to-b from-violet-50 to-white p-6">
      <form action={updatePassword} className="w-full max-w-sm rounded-xl border border-violet-100 bg-white p-6 shadow-sm">
        <h1 className="mb-2 text-lg font-medium text-violet-950">Set a new password</h1>
        <p className="mb-4 text-sm text-neutral-500">Choose a new password for your account.</p>
        <PasswordInput name="password" placeholder="New password" required minLength={6} />
