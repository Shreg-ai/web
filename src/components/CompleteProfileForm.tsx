  ...
  return (
    <div className="mx-auto w-full max-w-sm flex-1 p-6">
      <div className="rounded-xl border border-violet-100 bg-white p-6 shadow-sm">
        <h1 className="mb-2 text-lg font-medium text-violet-950">Finish setting up your account</h1>
        <p className="mb-4 text-sm text-neutral-500">
          Your account is signed in, but it's missing a username. Choose one to continue.
        </p>
        <input
          value={username}
